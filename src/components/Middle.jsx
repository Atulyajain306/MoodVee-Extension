...
const Middle = () => {
  ...
  return (
    <div className='container'>
        ...
        <div className='register'>Sign Up { ww ?  <PiConfettiThin style={{fontSize:"75px"}} className="icons" /> : <PiConfetti style={{fontSize:"75px"}} className='icons' />} </div>
  ...
  <Link to="/language" onClick={Handleback} style={{position:"relative",right:"90px",bottom: "5px",fontSize: "30px"}} className='Backward' > <MdOutlineArrowBack className='newlink' /></Link>
   <Link to ="/signin" onClick={Handleforward}  style={{bottom:"69px",fontSize:"30px",alignItems:"center",paddingLeft:"15px",paddingRight:"15px",marginTop:"4px", marginRight:"20px",paddingTop:"0px",paddingBottom:"0px"}} className='SignupArrow2' > <BsArrowRight style={{background:"none",padding:"0px"}}  /> </Link> 
    </div>
  )
}
